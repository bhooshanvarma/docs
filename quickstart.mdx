...
Go to \[[layer3x.com](http://layer3x.com)\]([https://layer3x.com](https://layer3x.com)) and click **Apply for Access**. 
...
curl -X POST [https://api.layer3x.com/v1/authorize](https://api.layer3x.com/v1/authorize) \\

  -H "Content-Type: application/json" \\

  -H "X-Agent-API-Key: YOUR\_AGENT\_API\_KEY" \\

  -d '{

    "action\_key": "payments.release",
...

{
  ...
  "request\_id": "3a1b2c3d-...",

  "decision": "ALLOW",

  "reason": "Auto-approved by policy",

  "matched\_policy": "Auto-approve small payments",
  ...
  "expires\_at": "2026-03-29T00:00:00Z"
