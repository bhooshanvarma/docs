...
description: "Connect Layer3x to Claude in 60 seconds"
...
\> Claude calls `authorize_payment` → Layer3x evaluates policies → Returns ESCALATED

\>

\> Claude: "This payment requires human approval. A request has been logged in your Layer3x dashboard."
